...
#include "../../../../../modules/gui/qt/util/timetooltip.hpp"
...
struct qt_meta_stringdata_TimeTooltip_t {
    QByteArrayData data[1];
    char stringdata0[12];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_TimeTooltip_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_TimeTooltip_t qt_meta_stringdata_TimeTooltip = {
    {
QT_MOC_LITERAL(0, 0, 11) // "TimeTooltip"
...
const QMetaObject TimeTooltip::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_TimeTooltip.data,
      qt_meta_data_TimeTooltip,  qt_static_metacall, nullptr, nullptr}
};
...
void *TimeTooltip::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TimeTooltip.stringdata0))
