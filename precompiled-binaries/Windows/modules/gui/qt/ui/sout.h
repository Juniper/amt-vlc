...
public:
    ...
    void setupUi(QWizard *Sout)
    {
        ...
        destinationWizardPage->setObjectName(QStringLiteral("destinationWizardPage"));
        verticalLayout_4 = new QVBoxLayout(destinationWizardPage);
        verticalLayout_4->setObjectName(QStringLiteral("verticalLayout_4"));
        destTab = new QTabWidget(destinationWizardPage);
        destTab->setObjectName(QStringLiteral("destTab"));
        tab = new QWidget();
        ...
        destBox->setObjectName(QStringLiteral("destBox"));
        ...
        profileSelect->setObjectName(QStringLiteral("profileSelect"));

        verticalLayout_3->addWidget(profileSelect);

        Sout->addPage(wizardPage);
        optionsWizardPage = new QWizardPage();
        optionsWizardPage->setObjectName(QStringLiteral("optionsWizardPage"));
        ...
        soutAll->setObjectName(QStringLiteral("soutAll"));
        ...
        mrlEdit->setObjectName(QStringLiteral("mrlEdit"));
    ...
    {
        Sout->setWindowTitle(Q_("Stream Output", Q_NULLPTR));
        sourceWizardPage->setTitle(Q_("Source", Q_NULLPTR));
        sourceWizardPage->setSubTitle(Q_("Set up media sources to stream", Q_NULLPTR));
        inputBox->setTitle(QString());
        destinationWizardPage->setTitle(Q_("Destination Setup", Q_NULLPTR));
        destinationWizardPage->setSubTitle(Q_("Select destinations to stream to", Q_NULLPTR));
        label_4->setText(Q_("Add destinations following the streaming methods you need. Be sure to check with transcoding that the format is compatible with the method used.", Q_NULLPTR));
        label_3->setText(Q_("New destination", Q_NULLPTR));
        addButton->setText(Q_("Add", Q_NULLPTR));
        localOutput->setText(Q_("Display locally", Q_NULLPTR));
        destTab->setTabText(destTab->indexOf(tab), QString());
        wizardPage->setTitle(Q_("Transcoding Options", Q_NULLPTR));
        wizardPage->setSubTitle(Q_("Select and choose transcoding options", Q_NULLPTR));
        transcodeBox->setText(Q_("Activate Transcoding", Q_NULLPTR));
        optionsWizardPage->setTitle(Q_("Option Setup", Q_NULLPTR));
        optionsWizardPage->setSubTitle(Q_("Set up any additional options for streaming", Q_NULLPTR));
        groupBox_3->setTitle(Q_("Miscellaneous Options", Q_NULLPTR));
        soutAll->setText(Q_("Stream all elementary streams", Q_NULLPTR));
        groupBox_4->setTitle(Q_("Generated stream output string", Q_NULLPTR));
    } // retranslateUi
