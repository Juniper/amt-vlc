...
#include "../../../../../modules/gui/qt/dialogs/errors.hpp"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ErrorsDialog_t, stringdata0) + ofs \
...
const QMetaObject ErrorsDialog::staticMetaObject = {
    { &QVLCDialog::staticMetaObject, qt_meta_stringdata_ErrorsDialog.data,
      qt_meta_data_ErrorsDialog,  qt_static_metacall, nullptr, nullptr}
};
...
void *ErrorsDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ErrorsDialog.stringdata0))
        return static_cast<void*>(this);
    if (!strcmp(_clname, "Singleton<ErrorsDialog>"))
        return static_cast< Singleton<ErrorsDialog>*>(this);
