...
#include "../../../../../modules/gui/qt/dialogs/fingerprintdialog.hpp"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_FingerprintDialog_t, stringdata0) + ofs \
...
void FingerprintDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FingerprintDialog::metaApplied)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject FingerprintDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_FingerprintDialog.data,
      qt_meta_data_FingerprintDialog,  qt_static_metacall, nullptr, nullptr}
};
...
void *FingerprintDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FingerprintDialog.stringdata0))
