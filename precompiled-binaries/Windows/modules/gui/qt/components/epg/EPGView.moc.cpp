...
const QMetaObject EPGGraphicsScene::staticMetaObject = {
    { &QGraphicsScene::staticMetaObject, qt_meta_stringdata_EPGGraphicsScene.data,
      qt_meta_data_EPGGraphicsScene,  qt_static_metacall, nullptr, nullptr}
};
...
void EPGView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EPGView::rangeChanged)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EPGView::itemFocused)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EPGView::programAdded)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EPGView::programActivated)) {
                *result = 3;
                return;
            }
        }
...
const QMetaObject EPGView::staticMetaObject = {
    { &QGraphicsView::staticMetaObject, qt_meta_stringdata_EPGView.data,
      qt_meta_data_EPGView,  qt_static_metacall, nullptr, nullptr}
};
