...
/* ./.libs/lt-vlc-cache-gen.c - temporary wrapper executable for .libs/vlc-cache-gen.exe
   Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-2

   The vlc-cache-gen program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "Z:\\home\\nlandsberg\\vlc\\win32\\lib\\.libs;Z:\\home\\nlandsberg\\vlc\\win32\\src\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "Z:\\home\\nlandsberg\\vlc\\contrib\\i686-w64-mingw32\\lib;Z:\\home\\nlandsberg\\vlc\\contrib\\i686-w64-mingw32\\bin;Z:\\home\\nlandsberg\\vlc\\win32\\lib\\.libs;Z:\\home\\nlandsberg\\vlc\\win32\\src\\.libs;Z:\\home\\nlandsberg\\vlc\\win32\\_win32\\lib;Z:\\home\\nlandsberg\\vlc\\win32\\_win32\\bin;";
const char * TARGET_PROGRAM_NAME = "vlc-cache-gen.exe"; /* hopefully, no .exe */
...
main (int argc, char *argv[])
{
  ...
  lt_debugprintf (__FILE__, __LINE__, "libtool wrapper (GNU libtool) 2.4.6 Debian-2.4.6-2\n");
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/bash\n", f);
  fputs ("\n", f);
  fputs ("# vlc-cache-gen - temporary wrapper script for .libs/vlc-cache-gen.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-2\n", f);
  fputs ("#\n", f);
  fputs ("# The vlc-cache-gen program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' ../lib/libvlc.la /home/nlandsberg/vlc/win32/src/libvlccore.", f);
  fputs ("la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("# script's /home/nlandsberg/vlc/win32/bin/../libtool value, followed by yes.\n", f);
  ...
  fputs ("        lt_dump_D=`$ECHO \"X$lt_script_arg0\" | /bin/sed -e 's/^X//' -e 's%/[^/]*", f);
  fputs ("$%%'`\n", f);
  fputs ("        test \"X$lt_dump_D\" = \"X$lt_script_arg0\" && lt_dump_D=.\n", f);
  fputs ("        lt_dump_F=`$ECHO \"X$lt_script_arg0\" | /bin/sed -e 's/^X//' -e 's%^.*/%%", f);
  fputs ("'`\n", f);
  ...
  fputs ("    echo \"vlc-cache-gen.exe:vlc-cache-gen:$LINENO: libtool wrapper (GNU libtool", f);
  fputs (") 2.4.6 Debian-2.4.6-2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"vlc-cache-gen.exe:vlc-cache-gen:$LINENO: newargv[$lt_dump_args_N]: $", f);
  fputs ("lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"vlc-cache-gen.exe:vlc-cache-gen:$LINENO: newargv[0]: $progdir/$p", f);
  fputs ("rogram\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='vlc-cache-gen.exe'\n", f);
  ...
  fputs ("    PATH=/home/nlandsberg/vlc/contrib/i686-w64-mingw32/lib:/home/nlandsberg/vlc", f);
  fputs ("/contrib/i686-w64-mingw32/bin:/home/nlandsberg/vlc/win32/lib/.libs:/home/nlands", f);
  fputs ("berg/vlc/win32/src/.libs:/home/nlandsberg/vlc/win32/_win32/lib:/home/nlandsberg", f);
  fputs ("/vlc/win32/_win32/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/home/nlandsberg/vlc/win32/lib/.libs:/home/nlandsberg/vlc/win32/src/.", f);
  fputs ("libs:$PATH\"\n", f);
  fputs ("\n", f);
  fputs ("    # Some systems cannot cope with colon-terminated PATH\n", f);
  fputs ("    # The second colon is a workaround for a bug in BeOS R4 sed\n", f);
  fputs ("    PATH=`$ECHO \"$PATH\" | /bin/sed 's/::*$//'`\n", f);
  fputs ("\n", f);
  fputs ("    export PATH\n", f);
  fputs ("\n", f);
  fputs ("    if test \"$libtool_execute_magic\" != \"%%%MAGIC variable%%%\"; then\n", f);
