...
public:
    ...
    void setupUi(QWidget *aboutWidget)
    {
        ...
        aboutWidget->setStyleSheet(QLatin1String(" QScrollBar:vertical {\n"
...
" }"));
        ...
        horizontalFrame->setStyleSheet(QLatin1String("background-color: rgb(245, 245, 245);\n"
"color:rgb(0,0,0);"));
        ...
        blablaPage->setObjectName(QStringLiteral("blablaPage"));
        ...
        updateLayout->setObjectName(QStringLiteral("updateLayout"));
        ...
        UpdateLabel->setStyleSheet(QStringLiteral("margin-bottom: 8px;margin-top: 4px;"));
        ...
        MainBlabla->setObjectName(QStringLiteral("MainBlabla"));
        ...
        MainBlabla->setStyleSheet(QStringLiteral("padding-right: 20px;"));
        ...
        licensePage->setObjectName(QStringLiteral("licensePage"));
        QFont font;
        ...
        authorsPage->setObjectName(QStringLiteral("authorsPage"));
        ...
        creditPage->setObjectName(QStringLiteral("creditPage"));
        ...
        VLCcone->setObjectName(QStringLiteral("VLCcone"));
        ...
        version->setStyleSheet(QLatin1String("font: 75 12pt \"Sans Serif\";\n"
"margin-bottom: 6px;"));
        ...
        footer->setStyleSheet(QStringLiteral("background-color: rgb(230, 230, 230);color:rgb(0,0,0);"));
        horizontalLayout_2 = new QHBoxLayout(footer);
        horizontalLayout_2->setContentsMargins(0, 0, 0, 0);
        horizontalLayout_2->setObjectName(QStringLiteral("horizontalLayout_2"));
        authorsButton = new QLabel(footer);
        authorsButton->setObjectName(QStringLiteral("authorsButton"));
        authorsButton->setCursor(QCursor(Qt::PointingHandCursor));
        authorsButton->setStyleSheet(QStringLiteral("padding: 10px"));
        ...
        licenseButton->setStyleSheet(QStringLiteral("padding: 10px"));
        ...
        creditsButton->setStyleSheet(QStringLiteral("padding: 10px;"));
    ...
    {
        aboutWidget->setWindowTitle(Q_("Dialog", Q_NULLPTR));
        UpdateLabel->setText(Q_("Update", Q_NULLPTR));
        checkUpdates->setText(Q_("Update", Q_NULLPTR));
