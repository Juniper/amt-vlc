...
#include "../../../../../modules/gui/qt/styles/seekstyle.hpp"
...
struct qt_meta_stringdata_SeekStyle_t {
    QByteArrayData data[1];
    char stringdata0[10];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SeekStyle_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SeekStyle_t qt_meta_stringdata_SeekStyle = {
    {
QT_MOC_LITERAL(0, 0, 9) // "SeekStyle"
...
const QMetaObject SeekStyle::staticMetaObject = {
    { &QProxyStyle::staticMetaObject, qt_meta_stringdata_SeekStyle.data,
      qt_meta_data_SeekStyle,  qt_static_metacall, nullptr, nullptr}
};
...
void *SeekStyle::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SeekStyle.stringdata0))
