...
/* ./.libs/lt-vlc.c - temporary wrapper executable for .libs/vlc.exe
   Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-2

   The vlc program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "vlc.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/bash\n", f);
  fputs ("\n", f);
  fputs ("# vlc - temporary wrapper script for .libs/vlc.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-2\n", f);
  fputs ("#\n", f);
  fputs ("# The vlc program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"vlc.exe:vlc:$LINENO: libtool wrapper (GNU libtool) 2.4.6 Debian-2.4.6", f);
  fputs ("-2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"vlc.exe:vlc:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"vlc.exe:vlc:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
